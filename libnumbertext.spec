...
Version  : 1.0.10
Release  : 9
URL      : https://github.com/Numbertext/libnumbertext/releases/download/1.0.10/libnumbertext-1.0.10.tar.xz
Source0  : https://github.com/Numbertext/libnumbertext/releases/download/1.0.10/libnumbertext-1.0.10.tar.xz
...
%prep
%setup -q -n libnumbertext-1.0.10
cd %{_builddir}/libnumbertext-1.0.10
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1649099550
...
cp %{_builddir}/libnumbertext-1.0.10/COPYING %{buildroot}/usr/share/package-licenses/libnumbertext/56039b4dae9c7929b60e3621b69d10e822fec61b
%make_install
