...
Version  : 1.0.6
Release  : 5
URL      : https://github.com/Numbertext/libnumbertext/releases/download/1.0.6/libnumbertext-1.0.6.tar.xz
Source0  : https://github.com/Numbertext/libnumbertext/releases/download/1.0.6/libnumbertext-1.0.6.tar.xz
...
%prep
%setup -q -n libnumbertext-1.0.6
cd %{_builddir}/libnumbertext-1.0.6
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1601329991
...
cp %{_builddir}/libnumbertext-1.0.6/COPYING %{buildroot}/usr/share/package-licenses/libnumbertext/56039b4dae9c7929b60e3621b69d10e822fec61b
%make_install
